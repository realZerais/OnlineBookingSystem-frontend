...
export const fetchAllUserProgress = async (username) => {
    try {
        const accessToken = getCookieValue('accessToken');

        const apiUrl = 'http://localhost:9000/progress/getAllUserProgress/' + username;
...
export const fetchUserBookProgress = async (username) => {
    try {
        const accessToken = getCookieValue('accessToken');
