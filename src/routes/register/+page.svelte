...
<dialog class="bg-slate-300 rounded-lg" open>
    <div class="flex flex-col items-center justify-center h-screen w-[40vw]">
        <div class="w-full max-w-m bg-white rounded-lg shadow-md p-6">
