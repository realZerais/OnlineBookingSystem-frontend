        ...
        <div class="w-[100%] bg-white shadow-lg rounded-lg overflow-hidden border border-black">
            ...
            <div id="myModal" class="modal hidden fixed inset-0 flex items-center justify-center z-50">
              ...
              <div class="flex flex-col modal-container bg-white w-[70%] h-[80%] rounded-[10px] shadow-lg z-50 overflow-y-auto pb-5">
                    ...
                    <div class="flex flex-col w-[50%] h-[100%] ">
                        ...
                        <div class="flex flex-col w-[100%] h-[100%] pl-[50px] pt-[20px] gap-y-5">
                            <h1 class="flex items-center justify-self-start gap-x-[50px]"> 
                                ...
                                <input name="name" class="bg-zinc-200 rounded-[5px] p-2" type="text" placeholder="Enter name"/>
                            </h1>
                            <h1 class="flex items-center justify-self-start gap-x-[53px]"> 
                                <label for="email">Email:</label>
                                <input name="email" class="bg-zinc-200 rounded-[5px] p-2" type="text" placeholder="Enter email"/>
                            </h1>
                            <h1 class="flex items-center justify-self-start gap-x-[45px]"> 
                                <label for="phone">Phone:</label>
                                <input name="phone" class="bg-zinc-200 rounded-[5px] p-2" type="text" placeholder="Enter contact number"/>
                            </h1>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col items-center w-[50%] h-[100%] ">
                        ...
                        <div class="flex flex-col w-[100%] h-[100%] pl-[65px] pt-[20px] gap-y-5 ">
                            <h1 class="flex items-center justify-self-start gap-x-[40px]"> 
                                ...
                                <input name="brand" class="bg-zinc-200 rounded-[5px] p-2" type="text" placeholder="Enter brand"/>
                            </h1>
                            <h1 class="flex items-center justify-self-start gap-x-[35px]"> 
                                <label for="model">Model:</label>
                                <input name="model" class="bg-zinc-200 rounded-[5px] p-2" type="text" placeholder="Enter model"/>
                            </h1>
                            <h1 class="flex items-center justify-self-start gap-x-[45px]"> 
                                <label for="issue">Issue:</label>
                                <input name="issue" class="bg-zinc-200 rounded-[5px] p-2" type="text" placeholder="Enter issue"/>
                            </h1>
                ...
                <button class="flex self-center items-center justify-center font-bakbak items-center bg-accent p-3 w-[15%] h-[15%] rounded-3xl text-[20px]">BOOK</button>
                </div>
              </div>
            </div>
        </div>
