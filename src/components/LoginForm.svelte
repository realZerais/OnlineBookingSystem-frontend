...
<div class="max-w-sm h-[70vh] relative flex flex-col p-4 rounded-xl text-black bg-slate-300">
    <div class="text-2xl font-bold mb-2 text-[#1e0e4b] text-center">Welcome Back!</div>
    ...
    <form class="flex flex-col gap-3">
        ...
        <button type="submit" class="bg-[#7747ff] w-max m-auto px-6 py-2 rounded text-white text-sm font-normal">Log In</button>
