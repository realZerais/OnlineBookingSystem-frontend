...
<div class="flex w-screen md:w-[80%] h-screen md:relative flex-col text-black gap-y-1 md:gap-y-2 p-4 pt-0" >
  <a href="/">
    <svg class="w-7 h-7 md:absolute top-[-3%] left-[-10%]" xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 448 512">
...
<div class="flex gap-x-2 self-center justify-self-end mt-7">
